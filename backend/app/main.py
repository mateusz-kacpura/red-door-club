...
def create_app() -> FastAPI:
    ...
    openapi_tags = [
        ...
        {
            "name": "nfc",
            "description": "NFC card tap handling, binding, and card management",
        },
        {
            "name": "members",
            "description": "Member profile, events, connections, taps, and service requests",
        },
        {
            "name": "events",
            "description": "Club event listing, RSVP, and check-in",
        },
        {
            "name": "admin",
            "description": "Admin operations: member CRM, floor view, prep checklist, analytics",
        },
        {
            "name": "websocket",
            "description": "WebSocket endpoints for real-time NFC event streaming",
        },
    ]
