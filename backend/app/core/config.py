...
class Settings(BaseSettings):
    ...
    LOGFIRE_SERVICE_NAME: str = "red_door"
    ...
    # === NFC Reader API Key ===
    # If set, GET /nfc/tap requires X-API-Key header matching this value.
    # Leave empty/unset to allow public (unauthenticated) tap requests.
    NFC_READER_API_KEY: str | None = None
